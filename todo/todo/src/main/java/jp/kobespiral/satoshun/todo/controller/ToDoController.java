...
public class ToDoController {
    ...
    String showToDoList(@PathVariable String mid, @ModelAttribute(name = "ToDoForm") ToDoForm form, Model model) {
        ...
        List<ToDo> todos = tService.getToDoes(mid);
        model.addAttribute("todos", todos);
        List<ToDo> dones = tService.getDones(mid);
    ...
    String showAllToDoList(@PathVariable String mid, Model model) {
        ...
        Member m = mService.getMember(mid);
        model.addAttribute("member", m);
        List<ToDo> todos = tService.getAllToDoes();
        model.addAttribute("todos", todos);
        List<ToDo> dones = tService.getAllDones();
        model.addAttribute("dones", dones);
        return "alllist";
    }
